  ...
  if (!isAuthenticated) {
    return (
      <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
        <Card className="w-full max-w-md bg-card border-border p-6 space-y-6 relative">
          <Button
            variant="ghost"
            size="icon"
            onClick={onClose}
          ...
          <div>
            <h2 className="text-2xl font-bold text-destructive">Dev Access</h2>
            <p className="text-sm text-muted-foreground">Enter password to access developer panel</p>
          </div>
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-input border-border focus:border-destructive focus:ring-destructive"
                autoFocus
              />
            </div>
            <Button
