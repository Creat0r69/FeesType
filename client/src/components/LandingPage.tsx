    ...
    <div className="min-h-screen bg-gradient-to-br from-gaming-dark via-racing-purple/20 to-gaming-dark text-white">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12 animate-in fade-in duration-500">
          ...
          {/* Join Button or Active Game Message */}
          {hasActiveGame && gameStatus === "waiting" && onJoinGame && (
            <div className="mb-8">
              <Button
                onClick={onJoinGame}
          ...
          {hasActiveGame && gameStatus === "active" && (
            <div className="mb-8">
              <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg px-8 py-6 max-w-2xl mx-auto">
                <p className="text-yellow-400 font-bold text-lg text-center">
                  🏁 Race in Progress
                </p>
                <p className="text-gray-400 text-center mt-2">
                  Please wait for the next game to be hosted
                </p>
              </div>
            </div>
          )}
